...
By contributing to Glowtone, you agree with the [Developer Certificate of Origin (DCO)][DCO].
...
Use American English to keep consistency across Glowtone.

If there is more than one acceptable spelling of the same word, first check if one word is already
being used in Glowtone, or in Mojang's Mappings, and if not, use the spelling that is most commonly used.
...
Glowtone is licensed under [FrozenBlock Modding Oasis License][LICENSE], and it has a [Developer Certificate of Origin (DCO)][DCO], which you are required to agree with to contribute.
...
[LICENSE]: ./LICENSE.md "Glowtone license file"
